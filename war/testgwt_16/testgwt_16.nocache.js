...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "testgwt_16" because\n';
  ...
  $wnd.__gwt_activeModules['testgwt_16'] = {
    'moduleName' : 'testgwt_16',
    'bindings' : function() {
      return {};
    }
  };
 ...
 * "/testgwt_16.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['testgwt_16'].superdevmode = true;

  var expectedSuffix = '/testgwt_16.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + testgwt_16 + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:testgwt_16';
  var devModeSessionKey = '__gwtDevModeSession:testgwt_16';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/testgwt_16/testgwt_16.nocache.js';
  ...
  $wnd.__gwt_activeModules['testgwt_16'].canRedirect = true;
  $wnd.__gwt_activeModules['testgwt_16'].superdevmode = true;
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/testgwt_16?user.agent=' + ua + '&_callback=' + callback;
